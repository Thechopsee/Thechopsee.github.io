...
function initFooter()
{
    ...
    const coLines = [
        ...
        { className: 'bottom_line', content: '🕘 25.-27.9.2026' },
    ...
    const registraceLines = [
        ...
        { className: 'bottom_line', content: '🗈 <a href="/propozice/propozice.pdf">Propozice</a>' },
...
{
    const menuItems = [
        { href: "/index.html", text: "Těrlická plachta 2026" },
